    ...
    .history
        ...
        .history__top-active
            ...
            .patient-billing__top-filter
                ...
                :options="['Johns Jacobs', 'Grace Paz']",
                :searchable="false",
                :allowEmpty="false",
                :showLabels="false",
                ...
                td
                    .sub-popup-menu-special(@mouseover="overMenu(index)", @mouseout="outMenu()")
                        ...
                        .sub-popup-menu__list-special(v-if="showMenu==index")
                            ...
                            a(href="#3", @click.prevent="openNewWindow('http://10.3.74.119/openemr/interface/patient_file/history/encounters.php?billing=1&issue=0&pagesize=20&pagestart=0')").sub-popup-menu__item View in {{$root._data.Patients[$root.activePacient].Category=='EPIC'?'EPIC':"EPIC"}}
